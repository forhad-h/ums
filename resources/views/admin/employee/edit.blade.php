                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group{{ $errors->has('experience') ? ' has-error' : '' }}">
                                ...
                                <textarea class="form-control" id="experience" name="experience" rows="3" placeholder="Enter your experience">{{$select->experience}}</textarea>
