...
<section class="content-header">
  <h5>
      {{ Breadcrumbs::render('addESalary', $select) }}
  </h5>
</section>
<section class="content">
    <div class="box box-primary">
        ...
        <form enctype="multipart/form-data" action="{{url('employee-salary/insert')}}" method="post">
            {{csrf_field()}}
             <div class="box-body">
                 <div class="col-sm-6 col-sm-offset-3">
                     <div class="form-group">
                         <label>Teacher ID</label>
                         <input type="text" class="form-control" name="employee_id" value="{{$select->id}}" readonly>
                     </div>
